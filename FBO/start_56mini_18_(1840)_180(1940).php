...
$array_cargo['cargo_id'] = "kantri_mini";
...
for ($k=1; $k<=2; $k++) { // количество столбцов
    $x_sdvig = 0.0 + $array_cargo['calculated_size']['length'] * ($k-1); // смещение по оси Х
        for ($i=1; $i<=18; $i++) { // количество рядов
...
add_tovar_v_massiv ($array_cargo, $kanta_standart_vertical_90);
$array_cargo['cargo_id'] = "kantri_mini";
$x = $array_cargo['calculated_size']['length']/2;
$y = $array_cargo['calculated_size']['height'];
$z = $array_cargo['calculated_size']['width']/2;
...
add_tovar_v_massiv ($array_cargo, $anker_8910_1840_gorizont_90);
$array_cargo['cargo_id'] = "1840-30";
$x = $array_cargo['calculated_size']['length']/2;
$y = $array_cargo['calculated_size']['height'];
$z = $array_cargo['calculated_size']['width']/2;
$j = $y/2;
...
add_tovar_v_massiv ($array_cargo, $anker_1940_gorizont_90);
$array_cargo['cargo_id'] = "1940-10";
$x = $array_cargo['calculated_size']['length']/2;
$y = $array_cargo['calculated_size']['height'];
$z = $array_cargo['calculated_size']['width']/2;
$j = $y/2;
$x_sdvig = 0.495*2+0.11;
$z_sdvig = 0;

for ($k=1; $k<=3; $k++) { // количество столбцов
...
add_tovar_v_massiv ($array_cargo, $anker_1940_gorizont);
$array_cargo['cargo_id'] = "1940-10";
$x = $array_cargo['calculated_size']['length']/2;
$y = $array_cargo['calculated_size']['height'];
$z = $array_cargo['calculated_size']['width']/2;
$j = $y/2;
$x_sdvig = 0.2;
$z_sdvig = 0.495+0.11*2;

for ($k=1; $k<=3; $k++) { // количество столбцов
       $x_sdvig = 0.2 + $x*2 * ($k-1); // смещение по оси Х
    for ($i=1; $i<=30; $i++) {
        $array_cargo['position']['x'] = $x + $x_sdvig;
        $array_cargo['position']['y'] = $j;
        $array_cargo['position']['z'] = $z + $z_sdvig;
...
//        $x_sdvig = 0.0 + $x * ($k-1); // смещение по оси Х
//     for ($i=1; $i<=40; $i++) {
//         $array_cargo['position']['x'] = $x + $x_sdvig;
//         $array_cargo['position']['y'] = $j;
//         $array_cargo['position']['z'] = $z + $z_sdvig;
